...
ui <- fluidPage(theme = shinytheme("superhero"),
                ...
                navbarPage("Effects of Democracy Around the World (Is Democracy the Best Form of Government?)",
                           ...
                           tabPanel("Democracy Growth",
                                    ...
                                    h3("Analysis"),
                                    p("The general trends of these lines suggest that more and dore counties are opting in to switch to democracies. The number of autocracies in the world is
                                      clearly diminishing and it appears as if those countries leaving the autocratic forms of government behind are the ones adeopting democracy. ")
                           ),
                          ...
                          Government although that is subject to change."),
                           ...
                           tabPanel("Life Expectancy",
                                    ...
                                    p("The overall life expectancy for all of these countries appears to have already been on an upward trend
                                      to begin with before the introduction of democracy. A relationship here seems a bit farfetched.")
                           ), 
                         ...
                         tabPanel("Analysis of Variables",
                                  p("Choose a variable to see a regression with all the data points available for that variable."))           
                                    
                                    
                                    #So here I think I will 
